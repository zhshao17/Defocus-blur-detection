...
from base_models.basic import _ConvBNReLU

__all__ = ['DeepLabV3Plus', 'get_deeplabv3_plus']
...
def get_deeplabv3_plus(backbone='xception',pretrained_base=True, **kwargs):
    model = DeepLabV3Plus(2, backbone=backbone, pretrained_base=pretrained_base, **kwargs)
    return model


if __name__ == '__main__':
    model = get_deeplabv3_plus()
