...
class AttU_Net(nn.Module):
    """
    Attention Unets implementation
...
class R2AttU_Net(nn.Module):
    """
    Residual Recuurent Block with attention Unets
...
class Unet_dict(nn.Module):
    """Unets which operates with filters dictionary values"""
...
#Need to check why this Unets is not workin properly
# 
