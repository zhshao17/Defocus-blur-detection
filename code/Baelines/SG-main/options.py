...
class TrainOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--epoch_start', type=int, default=1, help='epoch to start training from')
        self.parser.add_argument('--epoch_num', type=int, default=2000, help='number of epochs of training')
        self.parser.add_argument('--path_clear', type=str, default='./dataset/train_data/FCFB/FC',
                                 help='dir of the clear dataset')
        self.parser.add_argument('--path_blur', type=str, default='./dataset/train_data/FCFB/FB',
